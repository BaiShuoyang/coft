...
if($_SESSION['user_identity']=="normal_nonapproved"){
...
@ $db_user = new mysqli('localhost','root','fyp.2013','coft');
...
if (!in_array($itemname, $facility_array)){ //If this facility is not in the approved facility list of current user, the website will not show availability
  header("Location: postAccessDenied.php"); 
  exit;
}
...
<div class="content" style="min-height:1200px;"> 
  ...
  <fieldset>
    ...
    <table cellspacing="15" style="width:60%;">
      ...
      <?php if(($_SESSION['user_identity']=="normal") || ($_SESSION['user_identity']=="admin")){ ?>
